                ...
                <div class="col-md-3">
                    <div class="footer-widget-wrap">
                        ...
                        <p class="footer-about-us-desc">
                            ioSys is tech team which solving Hackverse problem statement-1 which is education and we are instructed to make a educational website for students where they can access lab metarials during the closure of educational institution <a href="https://themeqx.com" target="_blank"></a>
                        </p>
                ...
                <div class="col-md-3">
                    <div class="footer-widget-wrap contact-us-widget-wrap">
                        ...
                        <p class="footer-address">
                            66,Mohakhali,BRAC University,Dhaka 
                        </p>

                        <p class="mb-0"> Tel.: +880 1521583359 </p>
                        <p class="mb-0"> </p>
                        <p class="mb-0"> iosys.xyz@gmail.com </p>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="footer-bottom-contents-wrap d-flex">
                        ...
                        <div class="footer-bottom-left d-flex">
                            <h5 class="text-warning">ioSys</h5>
                            <span class="ml-4">Copyright © 2020 ioSys. All rights reserved.</span>
                        </div>
